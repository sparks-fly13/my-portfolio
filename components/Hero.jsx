...
import { SpotlightLeft } from './ui/SpotlightLeft';
    ...
    return (
        <div className='pb-20 pt-36'>
            <div>
                ...
                <SpotlightLeft className="top-10  left-3/4 h-[80vh] w-[50vw]" fill="purple" />
                <SpotlightLeft className="top-20 left-2/3 h-full w-[50vw]" fill="purple" />
                <SpotlightLeft className="top-30 left-3/4 h-full w-[50vw]" fill="blue" />
            </div>
            <AuroraBackground>
                <div
